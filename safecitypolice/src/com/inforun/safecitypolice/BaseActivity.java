...
public class BaseActivity extends FragmentActivity implements BDLocationListener{
	...
	protected ImageView img_right_fenxiang;
	...
	protected void initActionBar() {
		...
		View customActionBarView = LayoutInflater.from(
		...
		actionBarLeftLayout = (LinearLayout) customActionBarView
				.findViewById(R.id.leftLinear);
	...
	protected final Handler mHandler = new Handler() {
	    ...
	    public void handleMessage(android.os.Message msg) {
	        ...
	        case MSG_SET_ALIAS:
	            // 调用 JPush 接口来设置别名。
	        	System.out.println("JPushInterface.setAliasAndTags");
