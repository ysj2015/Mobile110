...
public class XRequestManager {
    ...
    public void setIsBackground(boolean isLoin) {
        this.isBackground = isLoin;
    }
    ...
    private void request(final HttpMethod method, final String url,
        ...
        getHttpUtils().send(method, url, params, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> arg0) {
                ...
                if (!isLoin && !isBackground) {
                   if (response.getStatusCode()==-1){
                       ((MyApplication) context.getApplicationContext()).reLogin(context);
                       return;
                   }
                }
                if (isLoin) {
    ...
    private boolean checkSession() {
        ...
        //((MyApplication) context.getApplicationContext()).saveSessionId(aa);
        return true;
    }
