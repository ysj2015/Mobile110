...
public class MediaUtils {
    ...
    public static String getMIMEType(String filePath) {
        ...
        /* 取得扩展名 */
        String end = fName
                .substring(fName.lastIndexOf("build/intermediates/exploded-aar/com.android.support/support-v4/22.2.1/res") + 1, fName.length())
                .toLowerCase();
     ...
     * @return
     */
    public static String getMp3Duration(String path) {
