...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void invokeOnScrolling() {
		if (mScrollListener instanceof OnPullToRefreshScrollListener) {
			OnPullToRefreshScrollListener l = (OnPullToRefreshScrollListener) mScrollListener;
			l.onPullToRefreshScrolling(this);
		}
	}
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
	...
	public void setPullToRefreshListViewListener(PullToRefreshListViewListener l) {
		mListViewListener = l;
	}
	 ...
	 */
	public interface OnPullToRefreshScrollListener extends OnScrollListener {
		public void onPullToRefreshScrolling(View view);
	}
