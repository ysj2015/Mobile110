...
import com.inforun.safecitypeople.fragment.AlarmFragment;
import com.inforun.safecitypeople.fragment.HistoryFragment;
import com.inforun.safecitypeople.fragment.PersonalFragment;
...
public class MainActivity extends BaseActivity implements OnTabChangeListener{
	...
	// tab
	private Class<?>[] fragmentArray = new Class[]{ AlarmFragment.class,
			HistoryFragment.class,PersonalFragment.class};
	private int iconArray[] = { R.drawable.alarm_button_normal,
			R.drawable.history_button_normal, R.drawable.personal_button_normal };
	private int iconArray2[] = { R.drawable.alarm_button_press,
			R.drawable.history_button_press, R.drawable.personal_button_press };
